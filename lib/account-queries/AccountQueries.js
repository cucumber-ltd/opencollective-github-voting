...
// TODO: Rename this to something more general like BankQueries
// We only need a single "store" which stores a hierarchy:
//
// AccountOwners
//   Accounts
//     Transactions
//
// Query methods should be:
//
// * getAccountOwner(uid, includeAccounts) -> person or github issue ()
// * getAccountOwners(accountType=github|user, includeAccounts) -> List of people or github issues
//
// This will allow us to draw the following UI:
//
// * Logged in user, with balance of all accounts (votes, dollars, github-activity)
// * A list of issues that can be voted on, with balance of all accounts
//
