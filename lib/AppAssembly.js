...
module.exports = class AppAssembly {
  constructor() {
    ...
    const accountCommands = new AccountCommands({ commandBus, accountStore: accountQueries })
    const transferCommands = new TransferCommands({ commandBus, accountStore: accountQueries })
    const webApp = new WebApp({ transferCommands, accountStore: accountQueries })
