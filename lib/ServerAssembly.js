...
const CommitDaysUpdater = require('./commits/CommitDaysUpdater')
...
module.exports = class ServerAssembly {
  constructor({ autoflush, commitsProvider, gitHubOauthId, gitHubOauthSecret }) {
    ...
    const commitDaysUpdater = new CommitDaysUpdater({ commitsProvider, bankQueries, accountCommands })
    const webApp = makeWebApp({ sub, transferCommands, bankQueries, gitHubOauthId, gitHubOauthSecret })
    ...
    this.commitDaysUpdater = commitDaysUpdater
